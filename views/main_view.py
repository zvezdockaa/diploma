...
class MainView(ctk.CTk):
    ...
    def build_table_headers(self):
        self.headers = ["Страна", "ВВП (млн USD)", "Военные расходы (млн USD)",
    ...
    def add_table_row(self, row_data):
        ...
        for col_idx, key in enumerate(self.headers):
            ...
            cell = ctk.CTkLabel(self.scrollable_frame, text=str(value), anchor="w",
    ...
    def on_add_country(self):
        ...
        self.controller.add_country(country_name)
    ...
    def open_formula_builder(self):
        ...
        all_metrics = [
            ...
            "Совокупная мощь по Чин-Лунгу", "Индекс национального потенциала", "Население", "ВВП ППС",
            "ВВП ППС на душу", "Глобальный ВВП", "Глобальные военные расходы", "Глобальное население",
            "Глобальный ВВП ППС на душу", "Часть ВР", "Часть ВВП", "Часть ВВП ППС", "Часть населения"
        ]
